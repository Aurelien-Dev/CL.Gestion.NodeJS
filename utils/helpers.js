...
var helpers = {
    ...
    randomColor: function(id, mode) {
        ...
        switch (parseInt(lastChar)) {
            case 0:
                return (mode === 'badge') ? 'color0Badge' : 'color0';
            case 1:
                return (mode === 'badge') ? 'color1Badge' : 'color1';
            case 2:
                return (mode === 'badge') ? 'color2Badge' : 'color2';
            case 3:
                return (mode === 'badge') ? 'color3Badge' : 'color3';
            case 4:
                return (mode === 'badge') ? 'color4Badge' : 'color4';
            case 5:
                return (mode === 'badge') ? 'color5Badge' : 'color5';
            case 6:
                return (mode === 'badge') ? 'color6Badge' : 'color6';
            case 7:
                return (mode === 'badge') ? 'color7Badge' : 'color7';
            case 8:
                return (mode === 'badge') ? 'color8Badge' : 'color8';
            case 9:
                return (mode === 'badge') ? 'color9Badge' : 'color9';
            default:
                return 'colorDefault';
        }
    }
